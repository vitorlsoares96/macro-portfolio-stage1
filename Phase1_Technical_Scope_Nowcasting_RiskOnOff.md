...
| FX (haven) | JPY/USD | FRED | `DEXJPUS` | Yen **appreciating** (`DEXJPUS` falling) → invert signal |
| Risk-free rate | 10-year Treasury | FRED | `DGS10` | Yields **falling fast** (flight-to-quality) → invert signal |
